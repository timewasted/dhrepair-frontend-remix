            ...
            <div className="mt-6 border-t border-b border-gray-500">
                <dl className="divide-y divide-gray-500">
                    ...
                    <div className="flex flex-wrap px-4 py-4">
                        ...
                        <dd className="w-full px-2 md:w-4/5">{formatMoney({cents: item.cost})}</dd>
                    </div>
                    <div className="flex flex-wrap px-4 py-4">
                        <dt className="font-semibold w-7/12 px-0 md:w-1/5">Description</dt>
                        <dd className="w-full px-2 md:w-4/5" dangerouslySetInnerHTML={{__html: item.description}}/>
                    </div>
                    {item.isPurchasable && (
                        <div className="flex flex-wrap px-4 py-4">
                            <dt className="font-semibold w-7/12 px-0 md:w-1/5">Availability</dt>
